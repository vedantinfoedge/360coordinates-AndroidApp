...
const AMENITIES = [
  ...
  { id: 'power_backup_ups', label: '24/7 Power Backup (UPS/DG)' },
  { id: 'high_speed_internet', label: 'High-Speed Internet/Fiber Ready' },
  { id: 'centralized_ac', label: 'Centralized AC (HVAC)' },
  { id: 'lifts_high_speed', label: 'Elevators/High-Speed Lifts' },
  { id: 'access_control', label: 'Access Control (RFID/Biometric)' },
  { id: 'visitor_parking', label: 'Visitor Parking' },
  { id: 'security_staff', label: 'Security Staff (24x7)' },
  { id: 'reception_desk', label: 'Reception Desk' },
  { id: 'lobby_area', label: 'Lobby Area' },
  { id: 'conference_room', label: 'Conference Room' },
  { id: 'washrooms', label: 'Washrooms (Private/Common)' },
  { id: 'pantry', label: 'Pantry/Kitchenette' },
  { id: 'power_supply_247', label: '24/7 Power Supply' },
  { id: 'customer_parking', label: 'Customer Parking' },
  { id: 'two_wheeler_parking', label: 'Two-Wheeler Parking' },
  { id: 'wheelchair_accessible', label: 'Wheelchair Accessible/Ramp' },
  { id: 'escalator_access', label: 'Lift/Escalator Access' },
  { id: 'display_window', label: 'Glass Front/Display Window' },
  { id: 'shutter_door', label: 'Shutter Door' },
  { id: 'mezzanine_floor', label: 'Mezzanine Floor/Storage Room' },
  { id: 'internal_roads', label: 'Internal Roads' },
  { id: 'led_lighting', label: 'LED Street Lighting' },
  { id: 'rainwater_harvesting', label: 'Rainwater Harvesting' },
  { id: 'underground_drainage', label: 'Underground Drainage' },
  { id: 'stormwater_drainage', label: 'Stormwater Drainage' },
  { id: 'water_line', label: 'Water Supply Line/Borewell' },
  { id: 'electricity_provision', label: 'Electricity Provision' },
  { id: 'gated_entrance', label: 'Gated Entrance' },
  { id: 'compound_wall', label: 'Compound Wall' },
  { id: 'security_cabin', label: 'Security Cabin' },
  { id: 'landscaped_garden', label: 'Landscaped Garden' },
  { id: 'jogging_track', label: 'Jogging/Walking Track' },
  { id: 'open_gym', label: 'Open Gym/Fitness Zone' },
];
