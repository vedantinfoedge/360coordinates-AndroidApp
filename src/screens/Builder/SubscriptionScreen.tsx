...
type SubscriptionScreenNavigationProp = CompositeNavigationProp<
  NativeStackNavigationProp<BuilderStackParamList, 'Subscription'>,
...
const SubscriptionScreen: React.FC<Props> = ({navigation}) => {
  ...
  useEffect(() => {
    const loadSubscriptionData = async () => {
      try {
        ...
        if (__DEV__) {
          console.error('[BuilderSubscription] Error loading subscription:', error);
        }
      } finally {
        setLoading(false);
      }
  ...
  const goToProfile = () => {
    (navigation as any).navigate('BuilderTabs', {screen: 'Profile'});
  };
        ...
        <Animated.View style={{opacity: fadeAnim, transform: [{translateY: slideAnim}]}}>
          ...
          <View style={styles.comingSoonCard}>
            ...
            <Text style={styles.comingSoonDescription}>
              We're working on subscription packages for Builders. Stay tuned for updates!
            </Text>
          </View>
