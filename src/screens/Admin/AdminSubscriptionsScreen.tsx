...
type AdminSubscriptionsScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'AdminSubscriptions'
>;

type Props = {
  navigation: AdminSubscriptionsScreenNavigationProp;
};
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Admin Subscriptions</Text>
        <TouchableOpacity onPress={logout}>
          <Text style={styles.logoutText}>Logout</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.content}>
        <Text style={styles.message}>Admin subscriptions management is available on the website.</Text>
