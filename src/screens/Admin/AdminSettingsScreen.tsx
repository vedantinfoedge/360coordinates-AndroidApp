...
type AdminSettingsScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'AdminSettings'
>;
...
const AdminSettingsScreen: React.FC<Props> = ({navigation}) => {
  ...
  const ADMIN_WEB_URL = 'https://demo1.indiapropertys.com/admin/settings';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.message}>Admin settings are available on the website.</Text>
